...
public class ManagerItemCreateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            managerService.createItem(itemCode.trim().toUpperCase(), name.trim(), price, managerId);

            resp.sendRedirect(req.getContextPath() + "/manager/items?success=item_created");
            ...
            e.printStackTrace();
            resp.sendRedirect(req.getContextPath() + "/manager/items?error=creation_failed");
        }
    }
}
